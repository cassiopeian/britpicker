    ...
    for (let i = 0; i < beSplit.length; i++) {
        ...
        translations.forEach(phrase => {
            ...
            if (threeWords.toLowerCase() == phrase.american
                ...
                beSplit.splice(beforePrevIndex, 1, caseMatch(phrase.plural, threeWords, phrase.altplural, index), hiddenSpace, hiddenSpace, hiddenSpace);
                ...
                aeSplit.splice(prevIndex, 3, phrase.american);
                // replace that with the pluralized british phrase and a hidden space
                beSplit.splice(prevIndex, 1, caseMatch(phrase.plural, twoWords, phrase.altplural, index-2), hiddenSpace);
